...
Route::post('/events/join/{id}', [GerenciadorEventos::class, 'joinEvent'])->middleware('auth');
Route::delete('/events/leave/{id}', [GerenciadorEventos::class, 'leaveEvent'])->middleware('auth');